...
static var player_tap_damage_base_cost: float = 10.0
static var player_tap_damage_cost_multiplier: float = 1.2
static var player_tap_damage_increase_per_level: float = 1.1

# Player Critical Chance Upgrades
static var player_crit_chance_base_cost: float = 50.0
static var player_crit_chance_cost_multiplier: float = 1.5
...
static var player_crit_multiplier_cost_multiplier: float = 1.6
...
# Enemy to stage
static var enemy_base_hp: float = 10
static var enemy_hp_multiplier_per_stage: float = 1.5
static var enemy_gold_base_reward: int = 10
static var enemy_gold_multiplier_reward: float = 1.2
...
static func get_player_crit_chance_upgrade_cost(current_level: int) -> float:
	return player_crit_chance_base_cost * pow(player_crit_chance_cost_multiplier, current_level)

static func get_player_crit_multiplier_upgrade_cost(current_level: int) -> float:
